...
<div class=\"col-md-3\">
    <fieldset class=\"accueil\">
        ...
        echo "
                ...
                <td>
                    <h2> Gestion des Fiches de Frais du Comptable </h2>
                </td>
                <td>
                    <h3>
                    <a href=\"";
        // line 27
        echo $this->env->getExtension('routing')->getPath("gsb_comptable_deconnexion");
        echo "\" 
    ...
    <div class=\"menu\">
        <ul class=\"nav\">
            <li> <a href=\"";
        // line 41
        echo $this->env->getExtension('routing')->getPath("gsb_suivi_paiement_frais");
        echo "\"
                    title=\"Suivre\"><h4>Suivre le paiement d'une fiche de frais</h4>
                 </a>
            </li>
              
            <li> <a href=\"";
        // line 46
        echo $this->env->getExtension('routing')->getPath("gsb_valide_frais");
        echo "\" 
                    title=\"Saisie\"><h4>Valider les fiches de frais</h4>
                 </a> 
            </li>
        </ul>
    </div>
